...
-(void) startService
{
    ...
    NSString *serviceName = [NSString stringWithFormat:@"ComboApp on %@", [[NSProcessInfo processInfo] hostName]];
    _netService = [[NSNetService alloc] initWithDomain:@"" type:@"_comboApp._tcp." name:serviceName port:self.listeningSocket.localPort];
